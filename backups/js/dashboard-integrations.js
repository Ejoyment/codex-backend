        ...
        try {
            ...
            if (result.success) {
                ...
                if (this.dashboardData.connectedIntegrations.length > 0) {
                    ...
                    console.warn('⚠️ No connected integrations returned from API!');
                }
                    ...
                    if (item.dataType === 'repositories') {
                        return `
                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded">
                                ...
                                <span class="text-xs text-gray-500">⭐ ${itemData.stars || 0}</span>
                            </div>
                        `;
                        ...
                        return `
                            <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded">
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-600">${itemData.author} • ${time}</p>
                                </div>
                            </div>
                        `;
                    }
                        ...
                        return `
                            <div class="flex items-start space-x-3 p-3 bg-gray-50 rounded">
                                <div class="flex-1">
                                    ...
                                    <p class="text-xs text-gray-500">#${itemData.channel} • ${time}</p>
                                </div>
                            </div>
                        `;
                    }
