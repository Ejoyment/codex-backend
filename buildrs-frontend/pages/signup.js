      ...
      <Head>
        ...
        <style>{`
          ...
          .feature-check {
            ...
            align-items: center;
            justify-content: center;
            background: rgba(47, 214, 230, 0.12);
            border: 1px solid rgba(47, 214, 230, 0.35);
            flex-shrink: 0;
          }
          .feature-check svg {
            color: #2fd6e6;
          ...
          .plan-btn.active {
            background: rgba(47, 214, 230, 0.08);
            border-color: rgba(47, 214, 230, 0.5);
            box-shadow: 0 0 0 3px rgba(47, 214, 230, 0.08);
          }
          .plan-name {
            font-size: 14px;
            font-weight: 600;
